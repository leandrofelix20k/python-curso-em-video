...
valorCasa = float(input('Digite o valor da casa que você pretende financiar: R$'))
salario = float(input('Digite quanto você ganha atualmente: R$'))
...
if(prestMensal > (salario * 0.30)):
    ...
    print('VALOR DA PRESTAÇÃO MENSAL É SUPERIOR A 30% DO SEU ATUAL SALÁRIO!')
else:
