...
if(idade < 18 and idade >= 0):
    ...
    print('Calma lá rapaizinho! Você ainda não está no período para se alistar! Você poderá se alistar a partir do ano {}'.format(int(ano) + tempoRestante))

elif(idade == 18):
    print('Vamo que vamo! Chegou a sua vez de se alistar!')
else:
    tempoAMais = idade - 18
    print('Infelizmente já passou o tempo para você se alistar!O ano que o senhor deveria ter se alistado foi  em {}'.format(int(ano) - tempoAMais))
